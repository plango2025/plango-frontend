    ...
    return (
      <div>
        {labels.map((label, index) => (
          <CheckboxCard.Root key={index} maxW="240px" colorPalette="teal" className={styles.customCheckboxCard}>
            <CheckboxCard.HiddenInput />
            <CheckboxCard.Control className={styles.customCheckboxControl}>
              <CheckboxCard.Label className={styles.customCheckboxLabel}>{label}</CheckboxCard.Label>
              <CheckboxCard.Indicator className={styles.customCheckboxIndicator} />
